...
{
  "skills": string[] — specific technical skills, frameworks, tools required,
  "seniority": one of "JUNIOR"|"MID"|"SENIOR"|"STAFF"|"PRINCIPAL" — expected level,
  "languages": string[] — required spoken languages (e.g. "English", "Spanish"),
  "summary": string — 1-2 sentence role summary focusing on the core responsibility
}
Rules:
